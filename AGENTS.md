...
Global CLI agent skill distribution system  discover, install, manage skills for Qwen Code, Claude Code, Cline, OpenCode

Stack detectado: Node.js, TypeScript.
